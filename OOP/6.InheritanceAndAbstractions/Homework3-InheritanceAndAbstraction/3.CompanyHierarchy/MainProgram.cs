        ...
        static void Main()
        {
            Manager mainManager = new Manager("First", "Manager", "01asdf", 1350m, DepartmentType.Accounting,
                new List<Employee>
                {
                    ...
                    {
                        new Project("Some project", DateTime.Parse("06.09.1999"), "random details about the project",
                            true),
            ...
            Manager theManager = new Manager("Georgi", "Petrov", "98126i82s", 6000, DepartmentType.Marketing,
                new List<Employee>()
                {
                    new Developer("Aleksandar", "Valentinov", "S775HCs", 2200, DepartmentType.Production,
                        new List<Project>()
                        {
                            new Project("SoftUniGame", DateTime.Today,
                                "The project is not ready, but we are working on it", true),
