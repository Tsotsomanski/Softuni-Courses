...
namespace Battleships
{
    ...
    public class Engine
    {
        ...
        private string SimulateAttack()
        {
            ...
            {
                return "Non- battleship cannot produce attack. ";
            }
            ...
            {
                return "Attacking ship is destroyed and cannot produce attack.";
            }
            ...
            {
                return "Attacker and defender both are destroyed";
            }
